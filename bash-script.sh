...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=emmmanuel1/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=emmanuel1/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=eon30/' /var/www/html/laravel/.env
